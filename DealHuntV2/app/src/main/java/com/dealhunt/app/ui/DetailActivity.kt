...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(s: Bundle?) {
        ...
        try {
                ...
                when (state) {
                    ...
                    is S.Ok -> {
                        ...
                        try { render(state.data) } catch (e: Throwable) {
                            Toast.makeText(this, "RENDER HATASI: ${e::class.simpleName}: ${e.message}", Toast.LENGTH_LONG).show()
                        }
                    }
                    is S.Err -> {
                        b.progressDetail.visibility = View.GONE
            ...
            step = "11-DONE"
            Toast.makeText(this, "Tum adimlar basarili!", Toast.LENGTH_SHORT).show()

        } catch (e: Throwable) {
            Toast.makeText(this, "HATA [$step]: ${e::class.simpleName}: ${e.message}", Toast.LENGTH_LONG).show()
        }
    }
